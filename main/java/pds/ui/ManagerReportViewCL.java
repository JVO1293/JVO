import main.java.pds.ui.ManagerReport;
...
public class ManagerReportViewCL extends ManagerReportView {
	...
	/**
	 * @see main.java.pds.ui.GeneralView#displayObject(java.lang.Object,
	 *      viewcontroller.GeneralView.OutputChannel)
	 */
	public void displayObject(Object object, OutputChannel outChannel) {
		...
		if (outChannel == ManagerReportOutputChannel.OCDisplayManagerReport) {
			...
			System.out.println(
					"Total Orders: " + managerReport.getNumberOfOrders());
			System.out.println("Average Cost: " +
					managerReport.calculateAvgCostPerOrder());
			System.out.println("Maximum Preparation Wait time: " +
					managerReport.calculateMaxTimeWaitingForPreparation());
			System.out.println("Average Preparation Wait Time: " +
					managerReport.calculateAvgTimeWaitingForPreparation());
			System.out.println("Maximum Cook Wait Time: " +
					managerReport.calculateMaxTimeWaitingToCook());
			System.out.println("Average Cook Wait Time: " +
					managerReport.calculateAvgTimeWaitingToCook());
			System.out.println("Maximum Delivery Pickup Time: " + managerReport
					.calculateMaxTimeWaitingToBeRetrievedForDelivery());
			System.out.println("Average Delivery Pickup Time: " + managerReport
					.calculateAvgTimeWaitingToBeRetrievedForDelivery());
			System.out.println("Maximum Order to Delivery Time: " +
					managerReport.maxTotalTime());
			System.out.println("Average Order to Delivery Time: " +
					managerReport.avgTotalTime());
			System.out.println();
	...
	/**
	 * Tells the view to get text input from the user, and iterates this until it
	 * is told to stop.
	 */
	...
	/**
	 * @see viewcontroller.GeneralView#setChannelEnabled(viewcontroller.GeneralView.InputChannel,
	 *      boolean)
	 */
